    ...
    <>
      <div className="mx-auto w-full !max-w-[1322px] px-4 py-6 sm:py-8 md:py-10">
        <div className={`benefit-block ${props}`}>
          <div className="list-benefit grid grid-cols-1 xs:grid-cols-2 md:grid-cols-2 items-start gap-5 sm:gap-6 md:gap-[20px] lg:gap-[30px] lg:grid-cols-4">
            <div className="benefit-item flex flex-col items-center justify-center p-3 sm:p-4">
              <i className="icon-phone-call text-4xl sm:text-5xl lg:text-7xl"></i>
              <div className="heading6 mt-3 sm:mt-4 lg:mt-5 text-center text-base sm:text-lg">
                24/7 Customer Service
              </div>
              <div className="mt-2 sm:mt-3 text-center text-sm sm:text-base font-normal leading-tight sm:leading-[22px] text-secondary md:text-[13px] md:leading-5">
            ...
            <div className="benefit-item flex flex-col items-center justify-center p-3 sm:p-4">
              ...
              <div className="heading6 mt-3 sm:mt-4 lg:mt-5 text-center text-base sm:text-lg">14-Day Money Back</div>
              <div className="mt-2 sm:mt-3 text-center text-sm sm:text-base font-normal leading-tight sm:leading-[22px] text-secondary md:text-[13px] md:leading-5">
            ...
            <div className="benefit-item flex flex-col items-center justify-center p-3 sm:p-4">
              ...
              <div className="heading6 mt-3 sm:mt-4 lg:mt-5 text-center text-base sm:text-lg">Our Guarantee</div>
              <div className="mt-2 sm:mt-3 text-center text-sm sm:text-base font-normal leading-tight sm:leading-[22px] text-secondary md:text-[13px] md:leading-5">
