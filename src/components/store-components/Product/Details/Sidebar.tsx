    ...
    <>
      <div className="product-detail sale sidebar">
        <div className="featured-product underwear py-10 md:py-20">
          <div className="container flex flex-wrap justify-between gap-y-6 max-sm:flex-col-reverse">
            <div className="sidebar w-full sm:w-[40%] sm:pr-10 lg:w-1/4 lg:pr-12">
              ...
              <div className="benefit mt-8 border-b border-line pb-8">
                ...
                <div className="list mt-4">
                  ...
                  <div className="item mt-5 flex gap-4">
                ...
                <div className="list">
                  {data
                    ...
                    .map((item) => (
                      <div
                        key={item.id}
                        className="item mt-4 flex cursor-pointer items-center gap-5"
                      ...
                      >
                        <Image
                          ...
                          className="aspect-[3/4] w-20 flex-shrink-0 rounded-lg object-cover"
                        />
                        <div>
            ...
            <div className="right w-full sm:w-[60%] sm:pl-3 lg:w-3/4">
              <div className="flex justify-between gap-y-6 max-lg:flex-col">
                <div className="list-img w-full lg:w-1/2 lg:pr-[40px]">
                  <Swiper
                    slidesPerView={1}
                    spaceBetween={0}
                ...
                <div className="product-infor w-full lg:w-1/2">
                  ...
                  <div className="list-action mt-6">
                    ...
                    <div className="mt-5 flex items-center gap-8 lg:gap-20">
                      <div
              ...
              <div className="desc-tab mt-[60px]">
                <div className="flex w-full items-center">
                  <div className="menu-tab flex items-center gap-8 lg:gap-[60px]">
                    <div
                ...
                <div className="desc-block mt-8">
                  ...
                  >
                    <div className="grid gap-8 gap-y-5 lg:grid-cols-2">
                      <div className="left">
                  ...
                  >
                    <div className="top-overview flex justify-between gap-12 gap-y-4 max-lg:flex-col max-sm:items-center lg:items-center">
                      <div className="left flex w-full items-center justify-between gap-y-4 max-sm:flex-col lg:w-1/2 lg:pr-5">
