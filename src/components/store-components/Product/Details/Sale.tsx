      ...
      <div className="product-detail sale">
          ...
          <div className="container flex flex-wrap justify-between gap-y-6">
            ...
            <div className="product-infor w-full md:w-1/2 md:pl-2 lg:pl-[15px]">
              ...
              <div className="list-action mt-6">
                <div className="sold flex flex-wrap justify-between gap-4">
        ...
        <div className="review-block bg-surface py-10 md:py-20">
          <div className="container">
            ...
            <div className="top-overview flex justify-between gap-y-10 py-6 max-lg:flex-col">
              <div className="rating black-start w-full lg:w-5/12">
