        ...
        <div className="featured-product underwear py-10 md:py-20">
          <div className="container flex flex-wrap justify-between gap-y-6">
            ...
            <div className="product-infor w-full md:w-1/2 md:pl-2 lg:pl-[15px]">
              ...
              <div className="list-group mt-1">
                {data
                  ...
                  .map((item) => (
                    <div
                      key={item.id}
                      className="item mt-6 flex items-center justify-between border-b border-line pb-6"
                    >
                      <div className="left flex items-center gap-5">
                        <div className="bg-img">
                          <Image
                            ...
                            height={400}
                            alt="img"
                            className="aspect-[3/4] w-[95px] flex-shrink-0 rounded-lg object-cover"
                          />
                        </div>
                        <div className="infor">
                          <div className="text-title">{item.name}</div>
                          <div className="select-block relative mt-2 w-fit">
                            <select className="text-button rounded-lg border border-line bg-white py-2 pl-3 pr-8">
                      ...
                      <div className="right">
                        <div className="quantity-block flex w-[120px] flex-shrink-0 items-center justify-between rounded-lg border border-line max-md:px-3 max-md:py-1.5 sm:w-[140px] md:p-3">
                          <Icon.Minus
                            size={20}
                            onClick={() => {
              ...
              <div className="total-price mt-6 flex items-center gap-3">
              ...
              <div className="get-it mt-6 border-b border-line pb-6">
