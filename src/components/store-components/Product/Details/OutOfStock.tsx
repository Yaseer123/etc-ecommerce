      ...
      <div className="product-detail grouped out-of-stock">
        <div className="featured-product underwear py-10 md:py-20">
          <div className="container flex flex-wrap justify-between gap-y-6">
            ...
            <div className="product-infor style-out-of-stock w-full md:w-1/2 md:pl-2 lg:pl-[15px]">
              ...
              <div className="list-action mt-6">
                <div className="choose-color mt-5">
                  ...
                  <div className="list-color mt-3 flex flex-wrap items-center gap-2">
                    {productMain.variation.map((item, index) => (
                      <div
                        className={`color-item relative h-12 w-12 rounded-xl duration-300`}
                        key={index}
                      >
                        <Image
                          src={item.colorImage}
                        ...
                        />
                        <div className="tag-action caption2 whitespace-nowrap rounded-sm bg-black px-1.5 py-0.5 capitalize text-white">
                          Out of stock
                        </div>
                      </div>
                    ))}
                ...
                <div className="choose-size mt-5">
                  ...
                  <div className="list-size mt-3 flex flex-wrap items-center gap-2">
                    {productMain.sizes.map((item, index) => (
                      <div
                        className={`size-item ${item === "freesize" ? "px-3 py-2" : "h-12 w-12"} text-button relative flex items-center justify-center rounded-full bg-surface text-secondary2`}
                        key={index}
                      >
                        {item}
                      </div>
                ...
                <div className="choose-quantity mt-3 flex items-center gap-5 gap-y-3 lg:justify-between">
                  ...
                  <div className="button-main w-full border border-line bg-surface text-center text-secondary2">
                    Out Of Stock
                  </div>
                </div>
