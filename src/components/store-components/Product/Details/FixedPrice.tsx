      ...
      <div className="product-detail grouped">
        <div className="featured-product underwear">
          <div className="container pt-10 md:pt-20">
            <div className="list-img grid w-full grid-cols-2 gap-4 md:grid-cols-3 md:grid-rows-2 lg:gap-[30px]">
              <div
                className="bg-img col-span-1 row-span-1 cursor-pointer overflow-hidden rounded-xl max-md:aspect-[3/4] md:row-span-2 lg:rounded-[20px]"
                onClick={() => {
              ...
              {productMain.images[3] && (
                <>
                  <div
                    className="bg-img col-span-2 row-span-1 aspect-[5/3] cursor-pointer overflow-hidden rounded-xl md:col-span-1 lg:rounded-[20px]"
                    onClick={() => {
          ...
          <div className="container flex flex-wrap justify-between gap-y-6 py-10 md:py-20">
            <div className="desc-tab w-full md:w-1/2 md:pr-4 lg:pr-[30px]">
              <div className="get-it border-b border-line pb-6">
              ...
              <div className="desc-block mt-6 border-b border-line pb-6">
                <div
                  className={`tab-item heading5 flex cursor-pointer items-center justify-between ${activeTab === "description" ? "active" : ""}`}
                ...
                <div
                  className={`desc-item description pt-5 md:pt-8 ${activeTab === "description" ? "open" : ""}`}
                >
                  <div className="right">
                  ...
                  <div className="left mt-5 md:mt-8">
                  ...
                  <div className="mt-5 grid grid-cols-2 gap-[30px] md:mt-8">
                    <div className="item">
                      <div className="icon-delivery-truck text-4xl"></div>
              ...
              <div className="desc-block mt-6 border-b border-line pb-6">
                <div
                  className={`tab-item heading5 flex cursor-pointer items-center justify-between ${activeTab === "specifications" ? "active" : ""}`}
                ...
                <div
                  className={`desc-item specifications flex items-center justify-center pt-5 md:pt-8 ${activeTab === "specifications" ? "open" : ""}`}
                >
                  <div className="w-full">
                    ...
                    <div className="item flex items-center gap-8 px-10 py-3">
                      <div className="text-title w-1/3 sm:w-1/4">
                        Outer Shell
                      </div>
                      <p>100% polyester</p>
                    </div>
              ...
              <div className="desc-block mt-6">
                <div
                  className={`tab-item heading5 flex cursor-pointer items-center justify-between ${activeTab === "review" ? "active" : ""}`}
                ...
                <div
                  className={`desc-item review-block pt-5 md:pt-8 ${activeTab === "review" ? "open" : ""}`}
                >
            ...
            <div className="product-infor w-full md:w-1/2 md:pl-4 lg:pl-[30px]">
              <div className="content box-shadow-sm rounded-2xl bg-white p-6 lg:rounded-3xl lg:p-10">
                ...
                <div className="list-action mt-6">
                  ...
                  <div className="choose-quantity mt-3 flex items-center gap-5 gap-y-3 md:flex-wrap lg:justify-between">
                  ...
                  <div className="mt-5 flex flex-wrap items-center gap-5 gap-y-4 lg:gap-20">
                    <div
          ...
          <div className="related-product pb-10 md:pb-20">
