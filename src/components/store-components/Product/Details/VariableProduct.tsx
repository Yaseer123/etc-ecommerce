            ...
            <div className="list-img flex w-full flex-col gap-5 md:w-1/2 md:pr-[45px]">
              ...
              <div className="mt-5 grid grid-cols-2 gap-5">
                <Image
                  ...
                  height={1000}
                  alt="prd-img"
                  className="aspect-[3/4] cursor-pointer rounded-[20px] object-cover"
                  onClick={() => {
                ...
                <div className="choose-color mt-5">
                  ...
                  <div className="list-color mt-3 flex flex-wrap items-center gap-2">
                    {["cotton", "kaki", "chenille", "denim"].map(
                      (item, index) => (
                        <div
                          className={`color-item relative h-12 w-12 rounded-xl duration-300 ${activeMaterial === item ? "active" : ""}`}
                          key={index}
