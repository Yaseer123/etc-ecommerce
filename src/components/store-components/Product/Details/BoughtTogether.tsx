      ...
      <div className="product-detail sale">
        <div className="featured-product underwear py-10 md:py-20">
          <div className="container flex flex-wrap justify-between gap-y-6">
            <div className="list-img grid h-fit w-full grid-cols-2 gap-5 md:w-1/2 md:pr-[45px]">
              {productMain.images.map((item, index) => (
                <Image
                  ...
                  height={1000}
                  alt="prd-img"
                  className="aspect-[3/4] w-full cursor-pointer rounded-[20px] object-cover"
                  onClick={() => {
            ...
            <div className="product-infor w-full md:w-1/2 md:pl-2 lg:pl-[15px]">
              ...
              <div className="list-bought-together mt-6">
                ...
                <div className="list-product-img mt-4 flex gap-3">
                  {data
                ...
                <div className="list-infor mt-2">
                  {data
                    ...
                    .map((item) => (
                      <div
                        className="item mt-2 flex items-center gap-3"
                        key={item.id}
                      >
                        ...
                        <div className="select-block relative w-fit">
                          <select
                            className="caption1 rounded-lg border border-line bg-white py-1 pl-2 pr-8"
                            defaultValue={"Select"}
                          >
