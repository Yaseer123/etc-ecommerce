...
export default function WishProductItem({
  ...
  const { product } = item;
  return (
    <div className="item flex w-full flex-col items-center justify-between gap-3 border-b border-[#ddd] py-5 focus:border-[#ddd] sm:flex-row">
      <div className="infor flex w-full flex-col items-center gap-3 sm:flex-row sm:gap-5">
